...
void MyGLWidget::createBuffers ()
{
  ...
  glm::vec3 VerticesB[4];  // Tres vèrtexs amb X, Y i Z
  VerticesB[0] = glm::vec3( 0.5, 0.0, 0.0);
  VerticesB[1] = glm::vec3( 0.5,  0.25, 0.0);
  VerticesB[2] = glm::vec3( 0.4, 0.25, 0.0);
  VerticesB[3] = glm::vec3( 0.4, 0.0, 0.0);
