...
QT_MOC_LITERAL(1, 11, 9), // "loadModel"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 6), // "getInt"
QT_MOC_LITERAL(4, 29, 1) // "i"

    },
    "MyGLWidget\0loadModel\0\0getInt\0i"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loadModel((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->getInt((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
