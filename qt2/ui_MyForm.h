...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(lineEdit, SIGNAL(enviaText(QString)), widget, SLOT(loadModel(QString)));
        QObject::connect(horizontalSlider, SIGNAL(valueChanged(int)), widget, SLOT(getInt(int)));
